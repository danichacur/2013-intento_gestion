    ...
    public partial class Admin : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            while (list_func.Read())
            {
                ...
                var estadisticas = Estadisticas.DropDownItems.Find(menu, true);
        ...
        private void pasajesXDestino_Click(object sender, EventArgs e)
        {
            Top_Destinos.generarEstadistica destinos = new Top_Destinos.generarEstadistica();
            destinos.Text = "Top 5 de los destinos con más pasajes comprados";
            destinos.vista = "Mas Pasajes Comprados";
            destinos.Show();
        }

        private void destinosConMicrosMasVacios_Click(object sender, EventArgs e)
        {
            Top_Destinos.generarEstadistica destinos = new Top_Destinos.generarEstadistica();
            destinos.Text = "Top 5 de los destinos con micros más vacíos";
            destinos.vista = "Micros mas vacios";
            destinos.Show();

        }

        private void destinosConPasajesCancelados_Click(object sender, EventArgs e)
        {
            Top_Destinos.generarEstadistica destinos = new Top_Destinos.generarEstadistica();
            destinos.Text = "Top 5 de los micros con mayor cantidad de días fuera de servicio";
            destinos.Show();
        }

        private void clientesConMasPuntosAcumuladosALaFecha_Click(object sender, EventArgs e)
        {
            Top_Destinos.generarEstadistica destinos = new Top_Destinos.generarEstadistica();
            destinos.Text = "Top 5 de los destinos con pasajes cancelados";
            destinos.vista = "Puntos Clientes";
            destinos.Show();
        }

        private void microsConMayorCantidadDeDiasFueraDeServicio_Click(object sender, EventArgs e)
        {
            Top_Destinos.generarEstadistica destinos = new Top_Destinos.generarEstadistica();
            destinos.Text = "Top 5 de los destinos con pasajes cancelados";
            destinos.Show();
